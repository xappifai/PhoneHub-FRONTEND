...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || 'AIzaSyD_NTT8L1UR84QeZgN5KYkvJpIkzYj8lvA',
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'phonehub-d0e84.firebaseapp.com',
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'phonehub-d0e84',
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'phonehub-d0e84.firebasestorage.app',  // Fixed: Use new format
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '397408357183',
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || '1:397408357183:web:536c0e8480da228bbb618a',
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || 'G-SKS32VLJ9Q',
}
